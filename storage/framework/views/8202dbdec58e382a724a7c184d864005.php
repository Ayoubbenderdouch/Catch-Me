...
<?php $__env->startSection('page-description', 'Monitor your app performance and user activity'); ?>
...
<?php endif; ?>
        ...
        <div>
            ...
            <p class="text-4xl font-bold"><?php echo e(number_format($stats['total_users'])); ?></p>
...
<?php endif; ?>
        ...
        <div>
            ...
            <p class="text-4xl font-bold"><?php echo e(number_format($stats['active_users_today'])); ?></p>
            <div class="mt-3 flex items-center text-sm">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div>
            ...
            <p class="text-4xl font-bold"><?php echo e(number_format($stats['total_matches'])); ?></p>
            <div class="mt-3 flex items-center text-sm">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div>
            ...
            <p class="text-4xl font-bold"><?php echo e(number_format($stats['pending_reports'])); ?></p>
            <div class="mt-3 flex items-center text-sm">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 mr-2 text-blue-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 mr-2 text-pink-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-pink-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
    <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all duration-200 border border-gray-100 group">
...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('admin.reports.index')); ?>" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all duration-200 border border-gray-100 group">
        <div class="flex items-center justify-between">
            <div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-orange-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('admin.map.index')); ?>" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-all duration-200 border border-gray-100 group">
        <div class="flex items-center justify-between">
            <div>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-green-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<script>
    ...
    const userRegistrationsOptions = {
        series: [{
            name: 'Registrations',
            data: <?php echo json_encode($userRegistrations->pluck('count'), 15, 512) ?>
        }],
        chart: {
            type: 'area',
            height: 300,
        ...
        xaxis: {
            categories: <?php echo json_encode($userRegistrations->pluck('date'), 15, 512) ?>,
            labels: {
                style: {
                    colors: '#64748B',
                    fontSize: '12px'
    ...
    const matchesOptions = {
        series: [{
            name: 'Matches',
            data: <?php echo json_encode($matchesPerDay->pluck('count'), 15, 512) ?>
        }],
        chart: {
            type: 'bar',
            height: 300,
        ...
        xaxis: {
            categories: <?php echo json_encode($matchesPerDay->pluck('date'), 15, 512) ?>,
            labels: {
                style: {
                    colors: '#64748B',
                    fontSize: '12px'
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/Desktop/Catch Me/Catch Me Dashbaord/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>