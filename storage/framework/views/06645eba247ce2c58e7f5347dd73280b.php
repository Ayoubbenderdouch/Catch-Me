<?php $__env->startSection('title', 'Live Map'); ?>
<?php $__env->startSection('page-title', 'Live Map - Online Users'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-lg shadow p-6">
    <div class="mb-4 flex justify-between items-center">
        <h3 class="text-lg font-semibold">Users Online (Last 30 minutes): <span id="userCount"><?php echo e($users->count()); ?></span></h3>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e($googleMapsApiKey); ?>"></script>
<script>
    let map;
    let markers = [];
    ...
    function loadUsers() {
        fetch('<?php echo e(route("admin.map.users-data")); ?>')
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/Desktop/Catch Me/Catch Me Dashbaord/resources/views/admin/map/index.blade.php ENDPATH**/ ?>