...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-pink-600','style' => 'fill: url(#gradient)']); ?>
...
<?php endif; ?>
            ...
            <div class="text-center mt-8">
                <p class="text-white/60 text-sm">
                    &copy; <?php echo e(date('Y')); ?> Catch Me. All rights reserved.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/macbook/Desktop/Catch Me/Catch Me Dashbaord/resources/views/auth/admin-login.blade.php ENDPATH**/ ?>