            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" id="max_distance" name="max_distance"
                           value="{{ old('max_distance', $settings['limits']['max_distance'] ?? 50) }}"
                           min="10" max="1000"
            ...
            <div class="space-y-3">
                <div class="flex items-center">
                    <input type="checkbox" id="ghost_mode_enabled" name="ghost_mode_enabled" value="1"
                           {{ old('ghost_mode_enabled', $settings['features']['ghost_mode_enabled'] ?? true) ? 'checked' : '' }}
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <textarea id="terms_content" name="terms_content" rows="6"
                          class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('terms_content', $settings['content']['terms_content'] ?? '') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea id="privacy_content" name="privacy_content" rows="6"
                          class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('privacy_content', $settings['content']['privacy_content'] ?? '') }}</textarea>
            </div>
        </div>
